<<<<<<< client/src/features/dashboard/pages/Dashboard.jsx
                ...
                <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-10">
                  <div className="max-w-xl text-center md:text-left">
                    ...
                    <h3 className="text-4xl font-black text-[var(--text)] tracking-tight mb-4">
                      Unlock the{" "}
                      <span className="text-[var(--primary)] text-5xl">
                        Apex
                      </span>{" "}
                      Tier.
                    </h3>
...
export default DashboardPage;
>>>>>>> client/src/features/dashboard/pages/Dashboard.jsx.remote.tmp
