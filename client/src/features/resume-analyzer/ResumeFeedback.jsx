  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const uploadRes = await axios.post(
        "http://localhost:5001/api/ai-resume/upload",
        formData,
        {
          headers: {
      ...
      const analyzeRes = await axios.post(
        "http://localhost:5001/api/ai-resume/analyze",
        { text },
      );
          ...
          best: {
            ...
            items:
              analysisData.skills && analysisData.skills.length > 0
                ...
                : ["Cloud Architecture", "System Design", "Agile Leadership"],
          },
          good: {
    ...
    try {
      ...
      alert(
        err.response?.data?.message ||
          "Failed to fix resume. Please try again.",
      );
    } finally {
